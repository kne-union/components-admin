const locale = {
  ...
  ThirdLoginSubtitle: '即将跳转到单点登录（SSO）平台完成登录',
  ...
  // OrgLink
  OrgLinkTitle: '同步组织架构',
  OrgLinkHint: '开启后，可从企业微信或钉钉同步组织架构。已同步的组织不可编辑或删除，仅可修改部门负责人。',
  OrgLinkEnable: '开启同步',
  OrgLinkSource: '同步来源',
  SourceWecom: '企业微信',
  SourceDingtalk: '钉钉',
  ...
  OrgLinkIntervalMonthly: '每个月',
  OrgLinkIntervalYearly: '每年',
  OrgLinkIntervalOff: '关闭',
  OrgLinkTargetId: '同步目标ID',
  OrgLinkTargetIdPlaceholder: '请选择同步目标ID',
  OrgLinkTargetIdDesc: '请选择需要同步的组织账号。',
  OrgLinkManualSync: '手动同步',
  OrgLinkCancel: '取消同步',
  OrgLinkCancelConfirm: '确定要取消同步吗？取消后已同步的组织将保留，但不再自动同步更新。',
  OrgLinkLastSyncTime: '上次同步时间',
  OrgLinkSaveSuccess: '同步配置保存成功',
  OrgLinkCancelSuccess: '已取消同步',
  ...
  ThirdLoginConfigCancelConfirm: '确定取消该渠道的单点登录（SSO）配置吗？',
  ThirdLoginConfigSaveSuccess: '单点登录（SSO）配置已保存',
  ThirdLoginConfigCancelSuccess: '已取消单点登录（SSO）配置',
  ThirdLoginBind: '绑定单点登录（SSO）',
  ThirdLoginUnbind: '解绑单点登录（SSO）',
  ThirdLoginBindHint: '复制链接或打开链接，在企业微信/钉钉/北森完成授权后即可绑定。',
  ThirdLoginBindLink: '绑定链接',
  ThirdLoginBindCopy: '复制链接',
  ThirdLoginBindPlatform: '选择平台',
  ThirdLoginBindSuccess: '绑定链接已生成',
  ThirdLoginBindGenerating: '正在生成绑定链接…',
  ThirdLoginBindRegenerate: '重新生成链接',
  ThirdLoginUnbindConfirm: '确定解除该用户的单点登录（SSO）绑定吗？',
  ThirdLoginUnbindSuccess: '已解除单点登录（SSO）绑定',
  ThirdLoginBound: '已绑定',
