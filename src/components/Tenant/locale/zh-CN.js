const locale = {
  ...
  // ThirdLoginConfig
  ThirdLoginConfigTitle: '第三方登录',
  ThirdLoginConfigHint: '配置后仅用于登录验证，不会同步组织或用户。凭证从 TARGET_LINKED_ 环境变量读取。',
  ThirdLoginConfigAdd: '添加渠道',
  ThirdLoginConfigEmpty: '暂未配置第三方登录渠道',
  ThirdLoginConfigSource: '登录渠道',
  ThirdLoginConfigTargetId: '关联目标ID',
  ThirdLoginConfigCancel: '取消',
  ThirdLoginConfigCancelConfirm: '确定取消该渠道的第三方登录配置吗？',
  ThirdLoginConfigSaveSuccess: '第三方登录配置已保存',
  ThirdLoginConfigCancelSuccess: '已取消第三方登录配置',
  ThirdLoginBind: '绑定第三方登录',
  ThirdLoginUnbind: '解绑第三方登录',
  ...
  ThirdLoginUnbindConfirm: '确定解除该用户的第三方登录绑定吗？',
  ThirdLoginUnbindSuccess: '已解除第三方登录绑定',
  ThirdLoginBound: '已绑定',
  ThirdLoginUnbound: '未绑定',
  ThirdLoginNoChannel: '请先配置第三方登录渠道',
