const locale = {
  ...
  // ThirdLoginConfig
  ThirdLoginConfigTitle: 'Third-party Login',
  ...
  ThirdLoginConfigEmpty: 'No third-party login channel configured',
  ThirdLoginConfigSource: 'Login channel',
  ThirdLoginConfigTargetId: 'Target ID',
  ThirdLoginConfigCancel: 'Remove',
  ThirdLoginConfigCancelConfirm: 'Remove this third-party login channel?',
  ThirdLoginConfigSaveSuccess: 'Third-party login config saved',
  ThirdLoginConfigCancelSuccess: 'Third-party login config removed',
  ThirdLoginBind: 'Bind third-party login',
  ThirdLoginUnbind: 'Unbind third-party login',
  ...
  ThirdLoginUnbindConfirm: 'Unbind third-party login for this user?',
  ThirdLoginUnbindSuccess: 'Third-party login unbound',
