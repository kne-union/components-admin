    ...
    return (
      <Dropdown
        ...
        popupRender={() => (
          <Space direction={'vertical'} className={style['content']}>
            ...
            <List className={style['options-list']}>
              ...
              <List.Item className={style['options-list-item']} onClick={logout}>
                <Flex gap={8} flex={1}>
        ...
        <Space className={style['user-tool']}>
          ...
          <div className={classnames(style['user-name'], 'user-tool-username')}>{name || formatMessage({ id: 'UserToolUnnamed' })}</div>
